...
def get_usa_prompt(days_remaining):
    return (
        ...
        f'NO frames, NO borders, NO vignettes overlaid on the scenery. Choose one breathtaking iconic spot'
        f'you can find in California that will compliment a postcard stlye photo.'
        ...
        f'the letters "sB" inside it. No other text or labels. '
...
def get_dolomites_prompt(days_remaining):
    return (
        ...
        f'NO frames, NO borders, NO vignettes overlaid on the scenery. Show iconic Dolomites scenery: '
        f'jagged limestone peaks, alpine meadows with wildflowers, a rustic mountain hut, '
        f'Lago di Braies, Seceda ridgeline, or Tre Cime di Lavaredo, or any breathtaking Dolomites spot. '
        f'In the upper portion of the image, overlay clean elegant white cursive script text that reads: '
